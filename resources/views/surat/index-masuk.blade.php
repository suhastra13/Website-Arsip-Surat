...
<x-app-layout>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full text-sm border border-blue-100 rounded-lg overflow-hidden bg-white">
            <thead class="bg-blue-600 text-white">
                <tr>
                    ...
                    <th class="px-3 py-2 text-left">Tanggal Terima</th>
                    <th class="px-3 py-2 text-left">Asal Surat</th>
            ...
            <tbody>
                ...
                <tr class="border-t border-slate-100 hover:bg-slate-50">
                    ...
                    <td class="px-3 py-2">{{ $item->tanggal_terima?->format('d-m-Y') }}</td>
                    <td class="px-3 py-2 truncate max-w-[150px]" title="{{ $item->asal_surat }}">
                        {{ $item->asal_surat }}
                    </td>
                    <td class="px-3 py-2">
                    ...
                    <td class="px-3 py-2 text-center">
                        ...
                        <button type="button"
                            ...
                            data-tgl-terima="{{ optional($item->tanggal_terima)->format('d-m-Y') }}"
        ...
        "email" => $u->email,
                        ...
                        <button type="button"
                            ...
                            data-tgl-terima="{{ optional($item->tanggal_terima)->format('Y-m-d') }}"
                            data-asal="{{ $item->asal_surat }}"
                            data-perihal="{{ $item->perihal }}"
                            data-ringkasan="{{ $item->ringkasan }}"
                            data-ttd="{{ $item->penandatangan }}"
    ...
    <div id="modal-detail"
        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl">
            <div class="px-5 py-3 border-b border-gray-200 flex justify-between items-center bg-blue-600 text-white rounded-t-lg">
                <h3 class="font-semibold text-lg">Detail Surat Masuk</h3>
    ...
    <div id="modal-edit"
        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl">
            <div class="px-5 py-3 border-b border-gray-200 flex justify-between items-center bg-blue-600 text-white rounded-t-lg">
                <h3 class="font-semibold text-lg">Edit Surat Masuk</h3>
            ...
            <form id="form-edit" method="POST" enctype="multipart/form-data" class="px-5 py-4 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-medium text-gray-700">Tanggal Terima</label>
                        <input type="date" name="tanggal_terima" id="edit-tanggal_terima"
                            class="mt-1 w-full rounded-md border-gray-300 text-sm"
                            required>
                    </div>
                    <div>
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-700">Asal Surat</label>
                    <input type="text" name="asal_surat" id="edit-asal_surat"
                        class="mt-1 w-full rounded-md border-gray-300 text-sm">
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-[11px] text-gray-500">
                        Tahan tombol <strong>Ctrl</strong> (Windows) atau <strong>Cmd</strong> (Mac) untuk memilih lebih dari satu.
                    </p>
                </div>
                ...
                btn.addEventListener('click', () => {
                    ...
                    detailBody.innerHTML = `
                        <dl class="space-y-2 text-sm text-gray-900">
                            ...
                            <div>
                                <dt class="font-semibold text-gray-600">Tanggal Terima</dt>
                                <dd>${btn.dataset.tglTerima || '-'}</dd>
                            </div>
                            <div>
                                <dt class="font-semibold text-gray-600">Asal Surat</dt>
                                <dd>${btn.dataset.asal || '-'}</dd>
                            </div>
                            <div>
            ...
            if (modalEdit && formEdit) {
                ...
                document.querySelectorAll('.btn-edit').forEach(btn => {
                    btn.addEventListener('click', () => {
                        ...
                        document.getElementById('edit-tanggal_terima').value = btn.dataset.tglTerima || '';
                        document.getElementById('edit-asal_surat').value = btn.dataset.asal || '';
